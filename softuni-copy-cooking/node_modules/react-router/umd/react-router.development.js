...
(function (global, factory) {
  ...
  function createRoutesFromChildren(children) {
    ...
    React.Children.forEach(children, element => {
      ...
      !(element.type === Route) ?  invariant(false, "[" + (typeof element.type === "string" ? element.type : element.type.name) + "] is not a <Route> component. AllRecipeCategory component children of <Routes> must be a <Route> or <React.Fragment>")  : void 0;
      let route = {
