...
function createRoutesFromChildren(children) {
  ...
  Children.forEach(children, element => {
    ...
    !(element.type === Route) ? process.env.NODE_ENV !== "production" ? invariant(false, "[" + (typeof element.type === "string" ? element.type : element.type.name) + "] is not a <Route> component. AllRecipeCategory component children of <Routes> must be a <Route> or <React.Fragment>") : invariant(false) : void 0;
    let route = {
